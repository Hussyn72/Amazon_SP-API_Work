...
$log_file = '/var/log/ownmail/SP-api_monthly_transaction_report.log';
...
if($Query)
{
	...
	foreach ($GetDatas as $GetData)
	{
		...
		$URL = $Endpoint.'/reports/2021-06-30/reports?reportTypes=GET_V2_SETTLEMENT_REPORT_DATA_XML&pageSize=100&createdSince=2024-02-01&createdUntil=2024-03-11'; //&createdSince=2023-07-30';     //&createdSince=2023-06-20&createdUntil=2023-08-15';
